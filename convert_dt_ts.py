...
def chrometime_to_date(datestamp,
    ...
    """
    Converts a timestamps in Chrome/Webkit format (default) to date
    and vice versa.
    epoch_yr=1601, epoch_mo=1, epoch_day=1: default for Chrome/Webkit 
    timestamp. For Unix, epoch_yr = 1970.
